...
//            throw new Exception("Please find the stacktrace" + e);
        }
    ...
    public boolean areElementsPresent(String elementName, String property) throws Exception {
...
//				new Object[] { element });
    ...
    public void updatePageTestData(String key, Object objectValue) {
        ...
        if (this.pageTestData.containsKey(key)) {
            throw new RuntimeException("You can't override the existing key, please add a new key");
        } else {
